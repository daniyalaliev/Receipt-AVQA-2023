...
df_orig = pd.read_csv('test_questions.csv')
df = df_orig.loc[(df_orig.receipt_currency=='Malaysian ringgit') & (df_orig.question_type == 'count') & (df_orig.split == 'test'), :]
...
encoded_dataset = VisionDataset(df, root, 'test')
